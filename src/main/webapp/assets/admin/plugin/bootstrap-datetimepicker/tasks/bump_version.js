module.exports = function (grunt) {
    grunt.registerTask('bump_version', function (version) {
        ...
        grunt.config('string-replace.bootstrap-datetimepicker-js', {
            files: {'src/js/bootstrap-datetimepicker.js': 'src/js/bootstrapV3-datetimepicker.js'},
            options: {
                replacements: [
                    {
                        pattern: /\/*! version : .*/,
        ...
        grunt.task.run([
            'string-replace:bootstrapV3-datetimepicker-js',
            'string-replace:bootstrapV3-datetimepicker-css',
