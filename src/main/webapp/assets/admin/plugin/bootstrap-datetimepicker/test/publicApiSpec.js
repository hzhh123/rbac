    ...
    describe('show() function', function () {
        ...
        describe('functionality', function () {
            ...
            it('actually shows the widget', function () {
                dtp.show();
                expect($(document).find('body').find('.bootstrapV3-datetimepicker-widget').length).toEqual(1);
            });
            ...
            it('applies the styles appended in the classify event handler', function () {
                ...
                expect($(document).find('body').find('.bootstrapV3-datetimepicker-widget td.day.injected').length).toEqual(42);
                expect($(document).find('body').find('.bootstrapV3-datetimepicker-widget td.day.humpday').length).toEqual(6);
            });
        });
    ...
    describe('hide() function', function () {
        ...
        describe('functionality', function () {
            ...
            it('actually hides the widget', function () {
                dtp.show();
                dtp.hide();
                expect($(document).find('body').find('.bootstrapV3-datetimepicker-widget').length).toEqual(0);
            });
        });
