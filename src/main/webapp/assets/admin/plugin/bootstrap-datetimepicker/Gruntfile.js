module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            target: {
                files: {
                    'build/js/bootstrap-datetimepicker.min.js': 'src/js/bootstrapV3-datetimepicker.js'
                }
            },
            options: {
                mangle: true,
        ...
        less: {
            production: {
                ...
                files: {
                    'build/css/bootstrap-datetimepicker.min.css': 'src/less/bootstrapV3-datetimepicker-build.less'
                }
            },
            development: {
                options: {
                ...
                files: {
                    'build/css/bootstrap-datetimepicker.css': 'src/less/bootstrapV3-datetimepicker-build.less'
                }
            }
        },
        env: {
        ...
        jasmine: {
            customTemplate: {
                ...
                options: {
                    ...
                    styles: [
                        'node_modules/bootstrapV3/dist/css/bootstrapV3.min.css',
                        'build/css/bootstrapV3-datetimepicker.min.css'
                    ],
                    vendor: [
                        'node_modules/jquery/dist/jquery.min.js',
                        'node_modules/moment/min/moment-with-locales.min.js',
                        'node_modules/moment-timezone/moment-timezone.js',
                        'node_modules/bootstrapV3/dist/js/bootstrapV3.min.js'
                    ],
                    display: 'none',
                    summary: 'true'
                }
